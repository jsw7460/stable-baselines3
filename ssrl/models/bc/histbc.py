...
from .policies import HistBCPolicy


class HistBC(OffPolicyAlgorithm):
    def __init__(
        self,
        policy: Union[str,],
    ...
    def _setup_model(self) -> None:
        super(HistBC, self)._setup_model()
    ...
    def train(self, gradient_steps: int, batch_size: int = 64) -> None:
        ...
        for gradient_step in range(gradient_steps):
            ...
            actions_pi, log_prob = self.actor.action_log_prob(replay_data.history.observations)
            ...
            # Do behavior clone
            log_likelihood = th.mean(self.actor.get_log_prob(replay_data.history.observations, replay_data.actions))
    ...
    def learn(
        ...
        tb_log_name: str = "HistBC",
        eval_log_path: Optional[str] = None,
        reset_num_timesteps: bool = True,
    ) -> OffPolicyAlgorithm:

        return super(HistBC, self).learn(
    ...
    def _excluded_save_params(self) -> List[str]:
        return super(HistBC, self)._excluded_save_params() + ["actor"]
