...
class BehaviorPolicy(BasePolicy):
    """
    Mimic the SAC policy, without q-networks.
    """
    def __init__(
        self,
        observation_space: gym.spaces.Space,
        ...
        """
        :param input_action: BCQ learns the behavior policy by using variational autoencoder,
        which takes a state - action pair. If input_action is False, then we input only a state.
        """
